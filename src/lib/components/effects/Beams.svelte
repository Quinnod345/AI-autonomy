...
`;
	...
	function createBeamMaterial(
		...
		uniforms.uSpeed = { value: speedVal };
		uniforms.uNoiseIntensity = { value: noiseIntensityVal };
...
gl_FragColor.rgb -= randomNoise / 15. * uNoiseIntensity;`
	...
	onMount(() => {
		...
		material = createBeamMaterial(speed, noiseIntensity, scale);
		...
		function animate(time: number) {
			...
			if (material && !prefersReducedMotion) {
...
<div class="beams-container" style="opacity: {opacity}" bind:this={container}></div>
